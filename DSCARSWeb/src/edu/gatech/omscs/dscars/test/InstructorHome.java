...
public class InstructorHome {
	...
	public Instructor findById(int id) {
		...
		try {
			Instructor instance = (Instructor) sessionFactory
					.getCurrentSession().get("Instructor", id);
			if (instance == null) {
	...
	public List<Instructor> findByExample(Instructor instance) {
		log.debug("finding Instructor instance by example");
		try {
			List<Instructor> results = (List<Instructor>) sessionFactory
					.getCurrentSession().createCriteria("Instructor")
